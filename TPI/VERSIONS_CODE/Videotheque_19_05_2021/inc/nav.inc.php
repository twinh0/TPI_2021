    ...
    <div class="container-fluid">
        ...
        <div class="d-flex navbar-nav" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown"><a class="nav-link" aria-current="page" href="../views/films.php">Liste des films</a></li>

                <?php
                //L'onglet Login/Logout s'affiche uniquement si l'on est déconnecté
                if ($_SESSION["isConnected"] == false) {
                    echo '<li class="nav-item dropdown"><a class="nav-link" aria-current="page" href="../views/register.php">Login/Register</a></li>';
                }
                ?>
                <?php
                //L'onglet profil s'affiche uniquement si l'on est connecté
                if ($_SESSION["isConnected"] == true) {
                    echo '<li class="nav-item dropdown"><a class="nav-link" aria-current="page" href="../views/profil.php">Profil</a></li>';
                }
                ?>
