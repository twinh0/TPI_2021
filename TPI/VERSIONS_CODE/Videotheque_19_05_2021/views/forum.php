    ...
    <div class="container">
        ...
        <table class="table table-sm table-dark table-hover">
            ...
            <tbody>
                ...
                //Puis pour chacun, on les affiche pour tout le monde
                foreach ($posts as $p) {
                ?>
        ...
        if ($_SESSION['isAdmin'] == 1) {
            //On affiche pour lui les posts en attente
        ?>
            <!-- SOUS-TITRE -->
            ...
            <table class="table table-sm table-dark table-hover">
                ...
                <tbody>
                    <!-- DONNÉES -->
                    <?php
                    //On récupère tous les posts en attente de vérification
                    $posts = GetAllPendingPost();
                    foreach ($posts as $p) {
                        //Puis on les affiche pour les admins pour qu'ils puissent les vérifier
                    ?>
                        <tr class="table-light">
                            <td><?= $p['dateCritique'] ?></td>
