...
if (filter_input(INPUT_GET, 'favoris') != null) {
    //Si le champs favoris = 1, met le film en favoris 
    ...
    //Redirige vers la page info personalisée
            ...
            <div class="col-4" style="width: 30%;">
                ...
                ?>
                        ...
                        <div class="text-center">
                            <a class="btn btn-danger" style="width: 40%; padding:5%; margin: 2%;" href="details_film.php?idFilm=<?= $film['idFilm'] ?>&favoris=2">
                    ...
                    ?>
                        <!-- Bouton ajouter -->
                        <div class="text-center">
                            <a class="btn btn-primary" style="width: 40%; padding:5%; margin: 2%;" href="details_film.php?idFilm=<?= $film['idFilm'] ?>&favoris=1">
                                <i class="fas fa-star"></i>
                            </a>
                        </div>
                <?php
